...
% (See http://www.gnu.org/copyleft/gpl.html)
   ...
   mapTest = zeros(7.5*4*2); mapTest(:) = -1;%ajout
   ...
   posi = [youbotPos(1) youbotPos(2) youbotEuler(3)];
  
   
   mapTest = ptsToCellmap(X(in), Y(in), pts(1,contacts), pts(2,contacts), mapTest,...
                0.25,posi,7.5,false); %ajout
